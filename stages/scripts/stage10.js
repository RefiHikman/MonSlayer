...
// MONSTER'S FIRE
let monsterFire1 = document.querySelector(".monster-fire-1");
let monsterFire2 = document.querySelector(".monster-fire-2");

monsterFire1.addEventListener("click", fireMouseClick);
monsterFire2.addEventListener("click", fireMouseClick);
function fireMouseClick() {
  count += 1;
  healthPoint -= fireDamage;
...
function startGame() {
  ...
  setTimeout(function () {
    ...
    setTimeout(function () {
      ...
      monsterFire1.style.visibility = "visible";
      monsterFire1.style.opacity = "1";
      monsterFire2.style.visibility = "visible";
      monsterFire2.style.opacity = "1";

      monsterFire1.style.transition = "0.2s";
      monsterFire2.style.transition = "0.2s";
    }, 500);
...
let prevStage = localStorage.getItem("stage9");
if (prevStage) {
...
function randomValues() {
  anime({
    targets: `.monster-fire-1, .monster-fire-2`,
    translateX: function () {
...
function startTimer(duration, display) {
  ...
  setInterval(function () {
    ...
    if (healthPoint <= 0) {
      ...
      localStorage.setItem(`stage10`, true);
    }
  }, 1000);
}
